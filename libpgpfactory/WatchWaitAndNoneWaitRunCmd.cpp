...
InterfaceWatchWaitAndNoneWaitRunCmdItem *WatchWaitAndNoneWaitRunCmd::addWithWait(std::string uniqueId, std::string fileName, std::string tmpFolder, std::string vscodePath)
{
...
InterfaceWatchWaitAndNoneWaitRunCmdItem *WatchWaitAndNoneWaitRunCmd::addWithOutWait(std::string uniqueId, std::string fileName, std::string tmpFolder, std::string vscodePath)
{
    std::lock_guard<std::mutex> guard(g_pages_mutex);
