...
void PassHelper::encryptFolderToFolder(std::string folderFrom,
                                       std::string folderTo,
...
void PassHelper::reEncryptFile(std::string pathFileToReEncrypt,
                               std::vector<std::string> encryptTo,
                               bool doSign)
{
    std::unique_ptr<InterfacePassFile> pf = getPassFile("");
...
void PassHelper::reEncryptStoreFolder(std::string nearestGpgIdFolder,
                                      std::vector<std::string> encryptTo,
